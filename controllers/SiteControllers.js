        ...
        try {
            ...
            if (type == 'destination')
                [result.destination, feild] = (
                    await connection.query('call railway.sp_statistic_destination(?);', year)
                )[0];
            else {
                [result.revenue, feild] = (await connection.query('call railway.sp_statistic_revenue(?);', year))[0];
                [result.person, feild] = (await connection.query('call railway.sp_statistic_person(?);', year))[0];
